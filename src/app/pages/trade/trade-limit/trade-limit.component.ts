...
@Component({
  selector: 'pancake-trade-limit',
  templateUrl: './trade-limit.component.html',
  styleUrls: ['./trade-limit.component.css']
})
export class TradeLimitComponent implements OnInit {
  value=new Date();
  result:any;
  coinPrice:any;
  volume24H:any;
...
clickOrder1(){
 if (this.order1===false && this.order2===true){
   this.order1=true
   this.order2=false
 }
}
clickOrder2(){
  if(this.order2===false && this.order1===true){
    this.order2=true;
    this.order1=false;
  }
}
